...
class TestTextBlockInvoice(TransactionCase):
    def setUp(self):
        super().setUp()
        account_model = self.env["ir.model"]._get("account.move")
    ...
    def test_invoice_textblock_creation(self):
        # preline textblock
    ...
    def test_invoice_textblock_update(self):
        # preline textblock
    ...
    def test_invoice_textblock_deletion(self):
        # preline textblock
