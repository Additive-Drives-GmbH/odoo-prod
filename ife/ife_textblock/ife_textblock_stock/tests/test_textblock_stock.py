...
class TestTextBlockStock(TransactionCase):
    def setUp(self):
        super().setUp()
        stock_model = self.env["ir.model"]._get("stock.picking")
    ...
    def test_stock_textblock_creation(self):
        # preline textblock
    ...
    def test_stock_textblock_update(self):
        # preline textblock
    ...
    def test_stock_textblock_deletion(self):
        # preline textblock
