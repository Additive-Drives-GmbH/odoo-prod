...
`feedback <https://github.com/Additive-Drives-GmbH/odoo-prod/issues/new?body=module:%20additive_quotation_report%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `odoo-prod <https://github.com/Additive-Drives-GmbH/odoo-prod>`_ project on GitHub.
